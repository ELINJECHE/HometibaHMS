        ...
        <div class="container-fluid px-4">
            <div class="section col-md-12 mt-2 p-2">
                ...
                <div class=" col-md-12 mx-auto shadow-lg  ">
                    ...
                    $sql = "SELECT * FROM applications Where Role='nurse' ";
                    $count = 1;
                    if ($result = mysqli_query($conn, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td>";
                                ?>
                                <a href="homecarenurse.php?id=<?php echo $row['id']; ?>&approve=app" title="approve doctor"
                                ...
                                echo "<td>";
                                ?>
                                <a href="homecarenurse.php?id=<?php echo $row['id']; ?>&del=delete" title="approve doctor"
