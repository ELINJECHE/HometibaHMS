        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5" style="border-color: rgba(256, 256, 256, .3) !important;">Welcome To Hometiba</h5>
                    <h4 class="display-3 text-white mb-md-2">Affordable Healthcare Solution Anywhere</h4>
                    <div class="pt-2">
                        <a href="applications.php" class="btn btn-outline-danger btn-sm text-light rounded-pill py-md-1 px-md-3 mx-2">Be Doctor</a>
                        <a href="applications.php" class="btn btn-outline-danger btn-sm text-light rounded-pill py-md-1 px-md-3 mx-2">Be Nurse</a>
                        <a href="login.php" class="btn btn-outline-danger btn-sm text-light rounded-pill py-md-1 px-md-3 mx-2"> Book Appointment</a>
